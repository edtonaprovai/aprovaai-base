...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Entrar — AprovaAI" },
      { name: "description", content: "Acesse sua conta AprovaAI." },
    ],
  }),
  component: LoginPage,
});
      ...
      <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-md items-center px-4 py-10 md:px-6">
        <Card className="w-full">
          <CardHeader className="space-y-2 text-center">
            ...
            <CardTitle className="text-2xl">Entrar no AprovaAI</CardTitle>
            <CardDescription>Use seu e-mail e senha ou continue com o Google.</CardDescription>
          </CardHeader>
